...
class DataClass {
  ...
  DataClass.fromJson(Map<String, dynamic> json) {
    ...
    date = json['date'] != null ? new DateClass2.fromJson(json['date']) : null;
...
class DateClass2 {
  ...
  DateClass2({this.readable, this.timestamp, this.hijri, this.gregorian});

  DateClass2.fromJson(Map<String, dynamic> json) {
...
class WeekdayClass {
  ...
  WeekdayClass({this.en});

  WeekdayClass.fromJson(Map<String, dynamic> json) {
    en = json['en'];
  }
...
class MonthClass {
  ...
  MonthClass({this.number, this.en});

  MonthClass.fromJson(Map<String, dynamic> json) {
    number = json['number'];
    en = json['en'];
  }
